...
class Perro(models.Model):
    ...
    fecha_perdido = models.DateField(null = True, blank = True, default = None)
    ultima_calle = models.CharField(max_length = 31, null = True, blank = True)
    ultima_colonia = models.CharField(max_length = 49, null = True, blank = True)
    ultima_alcaldia = models.CharField(max_length = 29, choices = ALCALDIA_CHOICES, null = True, blank = True)
    ultima_latitud = models.DecimalField(max_digits = 8, decimal_places = 4, validators = [MinValueValidator(0), MaxValueValidator(90)], null = True, blank = True)
    ultima_longitud = models.DecimalField(max_digits = 7, decimal_places = 3, validators = [MinValueValidator(0), MaxValueValidator(180)], null = True, blank = True)
    ...
    puppy = models.BooleanField(null = True, blank = True, default = False)
    rabia = models.BooleanField(null = True, blank = True, default = False)
    parvovirus_vacuna = models.BooleanField(null = True, blank = True, default = False)
    giardia = models.BooleanField(null = True, blank = True, default = False)
    cuadruple = models.BooleanField(null = True, blank = True, default = False)
    quintuple = models.BooleanField(null = True, blank = True, default = False)
    sextuple = models.BooleanField(null = True, blank = True, default = False)
    bordetella = models.BooleanField(null = True, blank = True, default = False)
    pulgas = models.BooleanField(null = True, blank = True, default = False)
    displasia_cadera = models.BooleanField(null = True, blank = True, default = False)
    nematodos = models.BooleanField(null = True, blank = True, default = False)
    cestodos = models.BooleanField(null = True, blank = True, default = False)
    giardas_coccidios = models.BooleanField(null = True, blank = True, default = False)
    parvovirus_enfermo = models.BooleanField(null = True, blank = True, default = False)
    identificador = models.CharField(max_length = 10, choices = IDENTIFICADOR_CHOICES, null = True, blank = True)
